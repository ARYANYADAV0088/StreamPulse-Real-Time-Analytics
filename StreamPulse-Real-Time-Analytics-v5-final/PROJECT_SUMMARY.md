...
Version 2.0 — consolidated real-time streaming analytics platform with Mini-Kafka, MongoDB persistence, consumer acknowledgements, idempotency, analytics, operational metrics and a redesigned React dashboard.
